...
#= TODO: Strongly consider implementing AbstractVector interface,
    where items are (generator, parameter) pairs.

Then you can phase out get_generators() and get_parameters() and add_generator().
=#
